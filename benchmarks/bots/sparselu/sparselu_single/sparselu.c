...
LOOP_BODY_2 ( iteration_fwd , 100000 , int , jj , int , kk , float**, BENCH)
{
...
LOOP_BODY_2 ( iteration_bdiv , 100000 , int , jj , int , kk , float**, BENCH)
{
if (BENCH[jj*bots_arg_size+kk] != NULL) CALL( bdiv ,BENCH[kk*bots_arg_size+kk], BENCH[jj*bots_arg_size+kk]);
}


LOOP_BODY_2 ( iteration_last , 100000 , int , ii , int , kk , float**, BENCH)
{
  int jj;
...
{
  CALL (sparselu_par_call_t ,BENCH);
}
